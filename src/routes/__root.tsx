...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Maze Mayhem Mania — a pixel-perfect chaos platformer with daily AI-validated levels." },
      { name: "author", content: "Maze Mayhem Mania" },
      { property: "og:title", content: "Maze Mayhem Mania" },
      { property: "og:description", content: "Maze Mayhem Mania — a pixel-perfect chaos platformer with daily AI-validated levels." },
